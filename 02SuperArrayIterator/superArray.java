//code is from Khinshan, since I accendently pushed the Int version of SuperArray
...
class SuperArray implements Iterable<String>{
    ...
    //modified by edmond
    //enables slicing
    public Iterator<String> iterator(int a,int b){
	return new SuperArrayIterator(this, a, b);
    }
    //modified by edmond
}
